...
const QuantityPredictionForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            const data = await predictQuantity(formData);
            setPrediction(data);
        } catch (err) {
            ...
            <div className="container mx-auto">
                ...
                <div className="bg-neutral-900 p-6 rounded-lg shadow-lg max-w-2xl mx-auto">
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div>
                            <label className="block text-sm font-medium mb-1">Selling Price (INR/kg)</label>
                            <input
                                type="number"
                                step="0.01"
                                min="0"
                    ...
                    {prediction && (
                        <div className="mt-6">
                            <h3 className="text-xl font-semibold mb-3 text-[#D50B8B]">Predicted Quantity</h3>
                            <div className="bg-black/50 p-4 rounded-lg">
                                <p className="text-2xl font-bold">
                                    {prediction.predicted_quantity.toFixed(2)} kg
                                </p>
                                <div className="mt-4">
...
export default QuantityPredictionForm; 